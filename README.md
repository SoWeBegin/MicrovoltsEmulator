...
The goal here is to make the game better. Not to host copies of the same version.
...
Missing: Clan support, Mailbox support, Joining rooms through the "Join" button.
