#ifndef UNMUTEROOM_SIMPLE_CHAT_COMMAND_HEADER
#define UNMUTEROOM_SIMPLE_CHAT_COMMAND_HEADER
...
namespace Main
{
	namespace Command
	{
		struct UnmuteRoom : public Common::Command::ISimpleRoomCommand<Main::Network::Session, Main::Classes::RoomsManager>
		{
			UnmuteRoom(const Common::Enums::PlayerGrade requiredGrade);
