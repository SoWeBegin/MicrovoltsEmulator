...
#pragma pack(push, 1)
		struct LobbyAccountInfo 
		{
			...
			explicit LobbyAccountInfo(const Main::Structures::AccountInfo& accountInfo)
				: dioramaInfo{ accountInfo.diorama }, totalKills{ accountInfo.totalKills }, totalDeaths{ accountInfo.deaths } 
				...
				, latestCharacterSelected{ static_cast<std::uint32_t>(accountInfo.latestSelectedCharacter) }, infected{ accountInfo.infected }
